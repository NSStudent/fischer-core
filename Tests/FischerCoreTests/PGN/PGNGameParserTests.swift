...
class PGNGameParserTests {
    ...
    @Test func pgn_with50MoveRule_Test() async throws {
        let input =
        """
        [Event "Belgrade"]
        [Site "Belgrade YUG"]
